    ...
    <div className="mb-10">
      <motion.div
        ...
        <div className="col-span-3">
          ...
          <button
            className="text-naranja font-kodchasan font-medium mt-4 hover:text-grisClaro border-naranja hover:border-1 hover:bg-gradient-to-r from-naranja to-orange-600 border-2 w-fit rounded-xl px-2 py-1 transition ease-in duration-200 animate-animacionEscalar">
