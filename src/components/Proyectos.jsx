...
let proyectos = [
    {
        ...
        imagen: jauImg,
        descripcion: 'App orientada a resolver problemas cotidianos, de forma sencilla o "casera"'
    ...
    },
    {
        ...
        imagen: brumImg,
        descripcion: 'Plataforma que permite, buscar flete y precio en base a nuestra necesidad de carga'
    },
    {
        id:3,
        nombre: 'React-Store',
        ...
        imagen: reactstore,
        descripcion: 'E-Commerce, presentado como proyecto final en curso de React JS en Coderhouse'
