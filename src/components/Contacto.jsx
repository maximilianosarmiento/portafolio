    ...
    <div id='contacto' className='flex flex-col md:flex-row max-w-4xl mx-auto mt-12'>
      <div className='flex flex-col   self-center w-1/2'>
          <div className='flex place-content-around group'>
              <h1 className="text-4xl   mb-4 font-kodchasan font-light text-azul dark:text-grisClaro ">{t("home.contactame")}<span className="text-4xl mb-4 font-kodchasan font-light text-naranja">me!</span></h1>
          </div>

          <div className='inline-flex justify-center w-60 self-center mt-3'>
